                ...
                <form action="" method="POST">
                    ...
                    <div class="card-body">
                        <div class="form-group">
                            <label class="mb-4">@lang('Sms Send Method')</label>
...
@push('breadcrumb-plugins')
    <button type="button" data-bs-target="#testSMSModal" data-bs-toggle="modal" class="btn btn-outline--primary">@lang('Send Test SMS')</button>
@endpush
@push('style')
<style>
    .method-select{
