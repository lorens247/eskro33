...
@section('panel')
    ...
    <form action="{{ route('admin.notification.template.update',$template->id) }}" method="post">
                    ...
                    <div class="card-body">
                        <div class="row">
                            <div class="col-md-12">
                                <div class="form-group">
                                    <input type="checkbox" data-height="46px" data-width="100%" data-onstyle="-success"
                                       data-offstyle="-danger" data-toggle="toggle" data-on="@lang('Send SMS')"
                    ...
                    <div class="card-body">
                        <div class="row">
                            <div class="col-md-12">
                                <div class="form-group">
                                    <input type="checkbox" data-height="46px" data-width="100%" data-onstyle="-success"
                                       data-offstyle="-danger" data-toggle="toggle" data-on="@lang('Send Telegram')"
        ...
        <button type="submit" class="btn btn--primary btn-block mt-4">@lang('Submit')</button>
    </form>
@endsection


@push('breadcrumb-plugins')
    <a href="{{ route('admin.notification.templates') }}" class="btn btn-sm btn-outline--primary"><i class="las la-undo"></i> @lang('Back') </a>
@endpush
