...
<body>
@if(@$installerExist)
    <div class="installer-exist">
        <h2 class="text-center text--danger">@lang('Please remove the "install" folder from the root path of the application.')</h2>
    </div>
    <script>
...
@include('admin.partials.searchmenu')
@stack('script-lib')
