                        ...
                        <div class="row">
                            <div class="col-xl-4">
                                <div class="form-group">
                                    <label class="fw-bold">@lang('Seo Image')</label>
                                    <div class="image-upload">
                                        <div class="thumb">
                                            <div class="avatar-preview">
                                                <div class="profilePicPreview" style="background-image: url({{getImage(fileManager()->seo()->path.'/'. @$seo->data_values->image,fileManager()->seo()->size) }})">
                                            ...
                                            <div class="avatar-edit">
                                                ...
                                                <small class="mt-2 text-facebook">@lang('Supported files'): <b>@lang('jpeg'), @lang('jpg')</b>. @lang('Image will be resized into') {{fileManager()->seo()->size}}@lang('px'). </small>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                            ...
                            <div class="col-xl-8 mt-xl-0 mt-4">
                                <div class="form-group ">
                                    <label class=" fw-bold">@lang('Meta Keywords')</label>
                                ...
                                <div class="form-group">
                                    <label class="  fw-bold">@lang('Meta Description')</label>
                                ...
                                <div class="form-group">
                                    <label class="  fw-bold">@lang('Social Title')</label>
                                ...
                                <div class="form-group">
                                    <label class="  fw-bold">@lang('Social Description')</label>
