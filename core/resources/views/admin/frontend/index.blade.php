                                    ...
                                    @else
                                        @if($k != 'images')
                                            @if($item == 'icon')
                                                <div class="col-md-12">
                                                    <div class="form-group ">
                                                        <label class=" fw-bold">{{__(inputTitle($k))}}</label>
                                                        <div class="input-group">
                                                            <input type="text" class="form-control iconPicker icon" name="{{ $k }}" value="{{ @$content->data_values->$k }}" autocomplete="off" required>
                                                            <span class="input-group-text  input-group-addon" data-icon="{{ @$content->data_values->$k ? substr(@$content->data_values->$k,10,-6) : 'las la-home' }}" role="iconpicker"></span>
                                                        </div>
                                                    </div>
                                                </div>
                                ...
                                @forelse($elements as $data)
                                    <tr>
                                        ...
                                        <td data-label="@lang('Action')">
                                            ...
                                            @endif
                                            <button class="btn btn-sm btn-outline--danger removeBtn" data-id="{{ $data->id }}"><i class="la la-trash"></i> @lang('Delete')</button>
                                        </td>
                                    </tr>
                                @empty
                                    <tr>
                                            ...
                                            <div class="image-upload">
                                                <div class="thumb">
                                                    <div class="avatar-preview">
                                                        ...
                                                        <label for="addImage{{ $loop->index }}" class="upload-image"><i class="las la-camera"></i></label>
                                                    </div>
                                                    <div class="avatar-edit">
                                            ...
                                            <div class="image-upload">
                                                <div class="thumb">
                                                    <div class="avatar-preview">
                                                        ...
                                                        <label for="uploadImage{{ $loop->index }}" class="upload-image"><i class="las la-camera"></i></label>
                                                    </div>
                                                    <div class="avatar-edit">
            ...
            <div class="modal-dialog modal-lg" role="document">
                <div class="modal-content">
                    ...
                    <form action="{{ route('admin.frontend.remove') }}" method="POST">
                        ...
                        <input type="hidden" name="id">
                        <div class="modal-body">
                            <p class="fw-bold">@lang('Are you sure to delete this item? Once deleted can not be undone.')</p>
                        </div>
                        <div class="modal-footer">
