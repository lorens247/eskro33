...
@if(!request()->routeIs('admin.users.notification.log'))
@tsknav('report')
@endif
@section('panel')
    <div class="row">
                                ...
                                @forelse($logs as $log)
                                    <tr>
                                        ...
                                        <td data-label="@lang('Action')">
                                            <button class="btn btn-sm btn-outline--primary notifyDetail" data-type="{{ $log->type }}" @if($log->type == 'email') data-message="{{ route('admin.report.email.details',$log->id)}}" @else data-message="{{ $log->message }}" @endif data-sent_to="{{ $log->sent_to }}" target="_blank"><i class="fas fa-desktop"></i> @lang('Detail')</button>
                                        </td>
                                    </tr>
                                @empty
                                    <tr>
