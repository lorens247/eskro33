...
@section('content')
                                    ...
                                    <div class="row form-group">
                                        ...
                                        <div class="col-md-11 col-9">
                                            <div class="file-upload-wrapper" data-text="Select your file!">
                                                <input type="file" name="attachments[]" id="inputAttachments" class="form-control custom-file-input form--control" accept=".jpg, .jpeg, .png, .pdf, .doc, .docx" class="form-control">
                                            </div>
                                            <div id="fileUploadsContainer"></div>
                                        </div>
                                        <div class="col-md-1 col-3">
                                            <button type="button" class="btn w-100 btn--primary addFile"><i class="fa fa-plus"></i></button>
                                        </div>
    ...
    <div class="modal custom--modal fade" id="DelModal">
        ...
        (function ($) {
            ...
            $('.addFile').on('click',function(){
                $("#fileUploadsContainer").append(`<div class="input-group my-3">
                        <input type="file" name="attachments[]" class="form--control custom-file-input form-control" accept=".jpg, .jpeg, .png, .pdf, .doc, .docx" required />
