                ...
                <div class="modal-dialog">
                    <div class="modal-content">
                        <div class="modal-header">
                            ...
                            <button type="button" class="close bg--danger text-white" data-bs-dismiss="modal">&times;</span>
                            </button>
                        </div>
            ...
            <div id="detailModal" class="modal fade" tabindex="-1" role="dialog">
                <div class="modal-dialog" role="document">
                    <div class="modal-content">
                        <div class="modal-header">
                            <h5 class="modal-title">@lang('Details')</h5>
                            <button type="button" class="bg--danger text-white" data-bs-dismiss="modal">
                                <span>&times;</span>
                            </button>
                        </div>
                        <div class="modal-body">
    ...
    <script>
        (function ($) {
            ...
            $('.approveBtn').on('click', function() {
                ...
                var ImgPath = "{{asset(fileManager()->verify()->deposit->path)}}/";
                var singleInfo = '';
