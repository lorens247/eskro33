...
class ProcessController extends Controller
{
    ...
    public static function process($deposit)
    {
        ...
        $all = CurlRequest::curlContent("https://blockchain.info/ticker");
        $res = json_decode($all);
        ...
        if ($deposit->btc_amo == 0 || $deposit->btc_wallet == "") {
            ...
            $resp = CurlRequest::curlContent($blockchain_receive_root . "v2/receive?key=" . $my_api_key . "&callback=" . urlencode($callback_url) . "&xpub=" . $my_xpub);
